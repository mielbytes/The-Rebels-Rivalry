...
function rookie:init(x, y)
    ...
    --rookie Animations--
    self.img = love.graphics.newImage("assets/images/rookie.png")
...
function rookie:move_toward_player(query)
    for i, v in pairs(query) do
        local player = v:getObject()
...
function rookie:take_damage(amount)
