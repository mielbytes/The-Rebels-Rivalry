...
function sniper:init(x, y)
    ...
    --sniper Animations--
    self.img = love.graphics.newImage("assets/images/sniper.png")
...
function sniper:move_toward_player(query)
    for i, v in pairs(query) do
        local player = v:getObject()
...
function sniper:take_damage(amount)
