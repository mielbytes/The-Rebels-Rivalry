...
function options:draw()
  if gameState == "optionsmenu" then
    ...
    love.graphics.rectangle("fill", fullscreenButton.x, fullscreenButton.y, fullscreenButton.w, fullscreenButton.h, buttonRadius)
    love.graphics.setFont(fonts.big)
    love.graphics.setColor(0, 0, 0)
    love.graphics.printf("FULLSCREEN", fullscreenButton.x, fullscreenButton.y + fullscreenButton.h / 2 - love.graphics.getFont():getHeight() / 2, fullscreenButton.w, "center")
    love.graphics.setColor(0, 0, 0)
    love.graphics.setLineWidth(3)
    love.graphics.rectangle("line", fullscreenButton.x, fullscreenButton.y, fullscreenButton.w, fullscreenButton.h, buttonRadius)
