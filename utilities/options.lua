...
function options:mousepressed(x, y, button)
  ...
  if button == 1 and x >= fullscreenButton.x and x <= fullscreenButton.x + fullscreenButton.w and y >= fullscreenButton.y and y <= fullscreenButton.y + fullscreenButton.h and gameState == "optionsmenu" then
    love.audio.stop(click)
    love.audio.play(click)
    toggleFullscreen()
  end
